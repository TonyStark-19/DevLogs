...
export default function Discipline() {
    ...
    return (
        <article className="max-w-3xl mx-auto px-2 py-10" id="Discipline">
            {/* Header */}
            <LogHeader
                title="Discipline"
            ...
            <div className="mt-8 space-y-6 dark:text-zinc-300 text-zinc-700 text-[15px] leading-relaxed antialiased">
                <p>
                    Discipline is a cornerstone of success for any developer. It involves the ability to
                    focus, stay <LogLink to="/consistency">consistent</LogLink>, and stick to a routine, even when
                ...
                <ul className="list-disc pl-5 space-y-2 text-zinc-600 dark:text-zinc-400">
                    ...
                    <li>
                        ...
                        they are done well. Discipline ensures that developers remain committed to their
                        personal and professional <LogLink to="/growth">growth</LogLink> even when the work gets tough or monotonous.
                    </li>
                </ul>
                ...
                <ul className="list-disc pl-5 space-y-2 text-zinc-600 dark:text-zinc-400">
                    <li>
                        They need to balance coding with testing, debugging, and documentation. Effective time
                ...
                <p>
                    Discipline also plays a major role in learning and improving coding skills. The tech
                    field is vast, with endless languages, frameworks, and tools to master.
                </p>

                <ul className="list-disc pl-5 space-y-2 text-zinc-600 dark:text-zinc-400">
                    <li>
                        Without discipline, a developer may lose focus or jump between too many topics without
                        making significant progress. By committing to daily learning and practice, developers
                ...
                <p className="border-l-2 border-zinc-300 dark:border-zinc-800 pl-4 italic text-zinc-500 dark:text-zinc-400">
                    This disciplined approach to problem-solving builds confidence and strengthens a
                    developer's ability to adapt to new challenges, ultimately leading to greater success in their career.
                </p>
            </div>

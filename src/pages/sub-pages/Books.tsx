        ...
        >
            ...
            <div className="mt-8 space-y-6 dark:text-zinc-300 text-zinc-700 text-[15px] leading-relaxed antialiased">
                <p>
                    ...
                    <LogLink to="/curiosity">curiosity</LogLink> and an unyielding urge to understand how the world operates—much like Tony Stark's self-described
                    "curse of knowledge"—reading has become a staple habit in my daily life.
                </p>

                <p>
                    Beyond accelerating personal <LogLink to="/growth">growth</LogLink> and offering fresh mental frameworks, carrying a book turns long, heavy
                    metro commutes to and from the office into productive, deeply peaceful sessions.
                </p>
                ...
                <ul className="list-disc pl-5 space-y-3 text-zinc-600 dark:text-zinc-400">
                    <li>
                        ...
                        <em className="text-xs text-zinc-500">(Héctor García & Francesc Miralles)</em>: Hands down the best guide for discovering your life's
                        true purpose and aligning daily effort with long-term fulfillment.
                    </li>
                    <li>
                        <strong className="text-zinc-900 dark:text-zinc-100 font-medium">A Brief History of Time</strong>{" "}
                        <em className="text-xs text-zinc-500">(Stephen Hawking)</em>: The very first book I ever bought. It sparked my deep obsession with
                        cosmic physics and space exploration.
                    </li>
                    <li>
                        <strong className="text-zinc-900 dark:text-zinc-100 font-medium">The Grand Design</strong>{" "}
                        <em className="text-xs text-zinc-500">(Stephen Hawking & Leonard Mlodinow)</em>: A fascinating exploration into quantum mechanics,
                        string theory, and the underlying architecture of the universe.
                    </li>
                    <li>
                        <strong className="text-zinc-900 dark:text-zinc-100 font-medium">Astrophysics for People in a Hurry</strong>{" "}
                        <em className="text-xs text-zinc-500">(Neil deGrasse Tyson)</em>: A concise, witty walkthrough of fundamental astrophysics—perfect
                        for quick, high-density reading sessions.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <em className="text-xs text-zinc-500">(Shrijeet Shandilya)</em>: A raw, emotional narrative capturing the pain of heartbreak,
                        fading relationships, and moving forward.
                    </li>
                    <li>
                        <strong className="text-zinc-900 dark:text-zinc-100 font-medium">Too Good to Be True</strong>{" "}
                        <em className="text-xs text-zinc-500">(Prajakta Koli)</em>: An engaging romantic fiction novel that offers a lighthearted, refreshing
                        escape from technical reading.
                    </li>
                </ul>
